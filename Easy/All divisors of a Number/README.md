<h2><a href="https://www.geeksforgeeks.org/problems/all-divisors-of-a-number/1?page=4&category=Mathematical&difficulty=Easy&sortBy=submissions">All divisors of a Number</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given&nbsp;an integer <strong>N,</strong>&nbsp;print all the divisors of N in the&nbsp;<strong>ascending </strong>order.</span><br>
&nbsp;</p>
