<h2><a href="https://www.geeksforgeeks.org/problems/triangular-number2850/1?page=4&category=Mathematical&difficulty=Easy&sortBy=submissions">Triangular Number</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number N.Check whether it is a triangular number or not.<br>
