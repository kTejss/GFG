<h2><a href="https://www.geeksforgeeks.org/problems/break-a-number5913/1?page=3&category=Mathematical&difficulty=Easy&sortBy=submissions">Break a number</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a really large number N, break it into 3 whole numbers such that they sum up to the original number and find the number of ways to do so. Since this number can be very large, return it modulo 10<sup>9</sup>+7.&nbsp;</span></p>
