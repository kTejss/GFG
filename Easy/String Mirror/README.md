<h2><a href="https://www.geeksforgeeks.org/problems/string-mirror--170647/1?page=2&category=Mathematical&difficulty=Easy&sortBy=submissions">String Mirror</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">You are given a string <strong>str</strong>&nbsp;of length <strong>n</strong>. You want to choose a non-zero integer k (k&lt;=n), such that you can perform the following operation:<br>
